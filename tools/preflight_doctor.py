...
def main() -> int:
    ...
    parser.add_argument("--live-work-preflight-smoke", action="store_true", help="Run a read-only local front-door work_preflight smoke and feed its measured latency/shape into the score.")
    ...
    parser.add_argument("--live-work-preflight-endpoint", default="", help="Endpoint for --live-work-preflight-smoke. Defaults to the local front-door discovery file.")
