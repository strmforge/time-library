...
MEMORY_AUTHORITY_BOUNDARY_NOTES = (
    "recall_only can read scoped preference/work-experience records after Time Library is installed and connected",
    "installing and connecting Time Library is the local trust boundary for normal scoped recall",
    ...
    "Time Library preserves original wording and source refs; local owner projection is not redacted",
