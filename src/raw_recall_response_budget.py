...
def compact_recall_payload(
    ...
    *,
    ...
    for key in (
        ...
        "source_collection_alias_applied",
        "source_collection_alias_boundary",
        ...
        "cross_window_read",
        "cross_window_read_allowed",
        "cross_window_permission_explicit",
        "cross_window_reason_is_authorization",
        "cross_window_reason",
        ...
        "freshness_fast_path",
        "default_recall_freshness_covered",
