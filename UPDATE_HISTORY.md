...
This page keeps the longer release highlights out of the README homepage. For the current release, see [RELEASE_NOTES_2026.6.20.2.md](RELEASE_NOTES_2026.6.20.2.md). For engineering-level changes, see [CHANGELOG.md](CHANGELOG.md).
...
- **安全边界不变**：继续保留 2026.6.20 的 passive-first 止血结果，普通聊天默认不被知意直接接管。
