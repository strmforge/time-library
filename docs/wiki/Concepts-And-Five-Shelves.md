...
This page explains the product model behind Memcore Cloud. The README should stay feature-first; this wiki page is where the deeper continuity model belongs.

## Continuity Model

Memcore Cloud separates two kinds of long-lived context:
...
Memcore Cloud keeps AI-readable knowledge sediment inside five existing
...
diff, easy to link, and easy to inspect. Memcore Cloud borrows that shape
