...
Memcore Cloud 2026.6.4 was verified on a Windows VM with a clean official Codex
install.
...
- `zhiyi_recall` capability check returned version `2026.6.4`;
...
这次已经验证：一台纯 Windows VM 上的官方 Codex，即使 `codex.exe` 不在 PATH，
