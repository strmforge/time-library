...
- 安装器、gateway health、active memory routing、preflight metadata、本地控制台版本文本和随包 Zhiyi skill 都统一报告 2026.6.12。

当前发布说明见 [RELEASE_NOTES_2026.6.12.md](RELEASE_NOTES_2026.6.12.md)，完整历史更新见 [UPDATE_HISTORY.md](UPDATE_HISTORY.md)，更底层变更见 [CHANGELOG.md](CHANGELOG.md)。
