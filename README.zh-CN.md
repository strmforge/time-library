...
2026.6.20.1 是当前已发布版本。可以下载 release zip，或使用 GitHub Release
里的版本化安装脚本。
...
当前已发布版本是 **2026.6.20.1**。这一版保留 2026.6.20 的安全止血，并把内部评测工具从公开产品树里移出。它重点修正本机 AI 工具接入边界、低资源默认、开工前上下文检查、记录医生、可回源召回，以及证据绑定回答路径。

发布说明见 [RELEASE_NOTES_2026.6.20.1.md](RELEASE_NOTES_2026.6.20.1.md)，完整历史更新见 [UPDATE_HISTORY.md](UPDATE_HISTORY.md)，更底层变更见 [CHANGELOG.md](CHANGELOG.md)。
