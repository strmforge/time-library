...
2026.7.10 是当前已发布版本。可以下载 release zip，或使用 GitHub Release
里的版本化安装脚本。
...
当前已发布版本是 **2026.7.10**。这一版是维护更新，优化阅读室信息、馆藏计数、本机服务状态和监听状态显示。旧 `memcore-cloud` 目录仍作为迁移源和卸载兜底保留，避免老用户数据丢失；本机 AI 工具接入边界、开工前上下文检查、记录医生、可回源召回，以及证据绑定回答路径继续保留。

发布说明见 [RELEASE_NOTES_2026.7.10.md](RELEASE_NOTES_2026.7.10.md)，完整历史更新见 [UPDATE_HISTORY.md](UPDATE_HISTORY.md)，更底层变更见 [CHANGELOG.md](CHANGELOG.md)。
